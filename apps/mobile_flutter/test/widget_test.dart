...
void main() {
  testWidgets('renders the APP-006 technical modules placeholder layout', (
    WidgetTester tester,
  ) async {
    ...
    expect(find.textContaining('APP-006'), findsOneWidget);
    expect(find.text('Módulos técnicos placeholder'), findsOneWidget);
    ...
    expect(find.text('Primera Travesía'), findsOneWidget);
  });
}
